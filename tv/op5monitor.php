...
<?php
if (($_GET["hosts"] == NULL) AND ($_GET["services"] == NULL)) {
print "		block.load(\"./monitor-api.php\", function(response){\n";
} elseif (($_GET["hosts"] !== NULL) AND ($_GET["services"] !== NULL)) {
print "		block.load(\"./monitor-api.php?hosts=".urlencode($_GET["hosts"])."&services=".urlencode($_GET["services"])."\", function(response){\n";
} elseif ($_GET["hosts"] !== NULL) {
print "		block.load(\"./monitor-api.php?hosts=".urlencode($_GET["hosts"])."\", function(response){\n";
} elseif ($_GET["services"] !== NULL) {
print "		block.load(\"./monitor-api.php?hosts=".urlencode($_GET["services"])."\", function(response){\n";
}
?>
                    $(this).html(response);
                    $("#loading").fadeOut(200);
